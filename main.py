...
with col1:
    ...
    \n\n Kasutusjuhend: 1) valmista ette tootekirjeldus (sisendtekst). 2) määra tarbijasegemendid lähtuvalt vanuserühma ja sissetulekute kombinatsioonidest. 3) sisesta ükshaaval tarbijasegmentide lõikes eeltoodud info äpi kasutajaliideses, saada ära. \
...
def update_text_with_example():
    print ("in updated")
    st.session_state.content_input = "jewelry, all colors, silver, responsible manufacturing"
